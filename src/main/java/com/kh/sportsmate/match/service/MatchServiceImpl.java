...
public class MatchServiceImpl implements MatchService {
    ...
    private HttpHeaders getHeaders() {
        ...
        headers.set("Authorization", "SECRET_KEY DEV743504924CD4B0D51D64AA360172F59C7D6CC");
	...
	public ReadyResponseDto payReady(String name, int totalPrice) {
        ...
        parameters.put("approval_url", "http://localhost:7777/SportsMate/payCompleted.st"); // 결제 성공 시 URL
        parameters.put("cancel_url", "http://localhost:7777/SportsMate/payCompleted.st");      // 결제 취소 시 URL
        parameters.put("fail_url", "http://localhost:7777/SportsMate/payCompleted.st");          // 결제 실패 시 URL
