			...
			<div class="desktop-board"> <!-- 데스크탑일 때 출력 -->
				...
				<div class="board-app-table-container"> <!-- 앱일 때 출력 -->
					<table>
				        ...
				        <tr>
				            <td class="board-app-table-view" colspan="2"><img src="${pageContext.request.contextPath}/resources/images/board_view.png" /> 3</td>
				        </tr>
				        <tr>
				    ...
				    <table>
				        ...
				        <tr>
				            <td class="board-app-table-view" colspan="2"><img src="${pageContext.request.contextPath}/resources/images/board_view.png" /> 32</td>
				        </tr>
				        <tr>
				    ...
				    <table>
				        ...
				        <tr>
				            <td class="board-app-table-view" colspan="2"><img src="${pageContext.request.contextPath}/resources/images/board_view.png" /> 28</td>
				        </tr>
				        <tr>
				    ...
				    <table>
				        ...
				        <tr>
				            <td class="board-app-table-view" colspan="2"><img src="${pageContext.request.contextPath}/resources/images/board_view.png" /> 67</td>
				        </tr>
				        <tr>
				    ...
				    <table>
				        ...
				        <tr>
				            <td class="board-app-table-view" colspan="2"><img src="${pageContext.request.contextPath}/resources/images/board_view.png" /> 103</td>
				        </tr>
				        <tr>
