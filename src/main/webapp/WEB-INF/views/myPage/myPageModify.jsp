            ...
            <form action="modifyMyInfo.mp" class="enroll-form" method="post" enctype="multipart/form-data">
               ...
               <div class="input-wrap">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" class="basic-address" id="baseAdd" name="memberBaseAdd" placeholder="기본 주소" value="${member.memAdd }">
                ...
                <div class="submit-btn">
                    <button type="submit" id="submitBtn" class="none-clickable">수정 완료</button>
                </div>
