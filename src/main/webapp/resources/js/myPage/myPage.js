...
viewButtons.forEach(button => {
	button.addEventListener('click', function () {
		...
		const skillRank = this.getAttribute('data-skillRank');
		const mannerRank = this.getAttribute('data-mannerRank');
		...
		document.getElementById('applicantSkillRank').textContent = skillRank;
		document.getElementById('applicantMannerRank').textContent = mannerRank;
